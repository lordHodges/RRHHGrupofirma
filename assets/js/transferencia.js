...
function cargarTabla(){
  var table = $('#tabla_transferencia').DataTable();
  table.destroy();

  $('.dataTables-transferencias').DataTable({
    "autoWidth": false,
        language: {
        ...
        "ajax": {
            url: "http://localhost/RRHH-FIRMA/index.php/getListadoTransferencias",
            type: 'GET'
        },
        "columnDefs": [{
                "targets": 5,
                "data": null,
                "defaultContent": '<button style="display:inline" type="button" id="btnVerListaContratos" class="btn btn-info" data-toggle="modal" data-target="#modalVerListaTransferencias"><i class="glyphicon glyphicon-folder-open"></i></button>   <button style="display:inline" type="button" id="btnModalCargarComprobante" class="btn btn-info" data-toggle="modal" data-target="#modalCargarComprobante"><i class="glyphicon glyphicon-open"></i></button>'
            }
