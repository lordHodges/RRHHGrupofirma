...
function getTransferenciasTrabajador(idTrabajador){
  ...
  $.ajax({
      ...
      // importarScript("http://imlchile.cl/grupofirma/assets/js/validaciones.js");
      $.each(response.msg, function (i, o) {
        ...
        if(o.atr_ruta == "vacio"){
          ...
          download = "http://imlchile.cl/grupofirma/index.php/TransferenciasController/descargarComprobante/"+o.cp_transferencia;
          if (permisoDescargar == "si") {
