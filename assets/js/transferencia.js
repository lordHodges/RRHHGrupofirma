...
function cargarTabla(permisoSubir){
  ...
  btnAcciones += '<button style="display:inline" type="button" id="btnVerListaTransferencias" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modalVerListaTransferencias"><i class="glyphicon glyphicon-folder-open"></i></button>';
  ...
  $('.dataTables-trabajadores').DataTable({
    ...
    "sInfoEmpty": false,
        ...
        "ajax": {
            url: "http://127.0.0.1/grupofirma/index.php/getListadoTrabajadoresContrato",
            type: 'GET'
        },
        "columnDefs": [{
                "targets": 5,
...
function getTransferenciasTrabajador(idTrabajador){
  ...
  $.ajax({
      ...
      // importarScript("http://127.0.0.1/grupofirma/assets/js/validaciones.js");
      $.each(response.msg, function (i, o) {
        ...
        if(o.atr_ruta == "vacio"){
          ...
          download = "http://127.0.0.1/grupofirma/index.php/TransferenciasController/descargarComprobante/"+o.cp_transferencia;
          if (permisoDescargar == "si") {
