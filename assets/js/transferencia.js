...
function cargarTabla(){
  ...
  $('.dataTables-trabajadores').DataTable({
    "autoWidth": false,
        ...
        "ajax": {
            url: "http://10.10.11.240/RRHH-FIRMA/getListadoTrabajadoresContrato",
            type: 'GET'
        },
        "columnDefs": [{
                "targets": 5,
  ...
  $.ajax({
      ...
      $.each(response.msg, function (i, o) {
        ...
        if(o.atr_ruta == "vacio"){
          ...
          download = "http://10.10.11.240/RRHH-FIRMA/TransferenciasController/descargarComprobante/"+o.cp_transferencia;
