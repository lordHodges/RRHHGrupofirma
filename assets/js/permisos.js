...
function cargarTablaPerfiles() {
	...
	btnAcciones =
		'<a style="display:inline" href="http://localhost/RRHHGrupofirma/index.php/inicioPermisosPerfil" type="button" id="btnVerPermisos" class="btn btn-info btn-sm"><i class="fa fa-shield"></i></a>';
	...
	$(".dataTables-perfiles").DataTable({
		...
		ajax: {
			url: "http://localhost/RRHHGrupofirma/index.php/getPerfilesTabla",
			type: "GET",
		},
		columnDefs: [
			{
...
function cargarTablaUsuarios() {
	...
	var btnAcciones =
		'<a style="display:inline" href="http://localhost/RRHHGrupofirma/index.php/inicioPermisosUsuario" type="button" id="btnVerPermisos" class="btn btn-info btn-sm"><i class="fa fa-shield"></i></a>';
	...
	$(".dataTables-usuarios").DataTable({
		...
		ajax: {
			url: "http://localhost/RRHHGrupofirma/index.php/getListadoUsuarios",
			type: "GET",
		},
		columnDefs: [
			{
