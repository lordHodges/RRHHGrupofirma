...
function cargarTablaPerfiles(){
  ...
  btnAcciones = '<a style="display:inline" href="http://127.0.0.1/grupofirma/index.php/inicioPermisosPerfil" type="button" id="btnVerPermisos" class="btn btn-info btn-sm"><i class="fa fa-shield"></i></a>';
  ...
  $('.dataTables-perfiles').DataTable({
    ...
    "sInfoEmpty": false,
        ...
        "ajax": {
            url: "http://127.0.0.1/grupofirma/index.php/getPerfilesTabla",
            type: 'GET'
        },
        "columnDefs": [{
                "targets": 2,
...
function cargarTablaUsuarios(){
  ...
  var btnAcciones = '<a style="display:inline" href="http://127.0.0.1/grupofirma/index.php/inicioPermisosUsuario" type="button" id="btnVerPermisos" class="btn btn-info btn-sm"><i class="fa fa-shield"></i></a>';
    ...
    $('.dataTables-usuarios').DataTable({
        "autoWidth": false,
          ...
          "ajax": {
              url: "http://127.0.0.1/grupofirma/index.php/getListadoUsuarios",
              type: 'GET'
          },
          "columnDefs": [{
            "targets": 5,
