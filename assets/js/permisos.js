...
function cargarTablaPerfiles(){
  ...
  btnAcciones = '<a style="display:inline" href="http://imlchile.cl/grupofirma/index.php/inicioPermisosPerfil" type="button" id="btnVerPermisos" class="btn btn-info btn-sm"><i class="fa fa-shield"></i></a>';
  ...
  $('.dataTables-perfiles').DataTable({
    ...
    "sInfoEmpty": false,
        ...
        "ajax": {
            url: "http://imlchile.cl/grupofirma/index.php/getPerfilesTabla",
            type: 'GET'
        },
        "columnDefs": [{
                "targets": 2,
...
function cargarTablaUsuarios(){
  ...
  var btnAcciones = '<a style="display:inline" href="http://imlchile.cl/grupofirma/index.php/inicioPermisosUsuario" type="button" id="btnVerPermisos" class="btn btn-info btn-sm"><i class="fa fa-shield"></i></a>';
