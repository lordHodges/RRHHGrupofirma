...
function cargarTabla(cargo, permisoEliminar){
  ...
  $('.dataTables-requerimientosMinimos').DataTable({
        ...
        "ajax": {
<<<<<<< HEAD
            url: 'http://localhost/GRUPOFIRMA/index.php/getListadoRequisitosMinimosDataTable?id='+cargo,
=======
            url: 'http://10.10.11.240/GRUPOFIRMA/index.php/getListadoRequisitosMinimosDataTable?id='+cargo,
>>>>>>> 6d452e33e03ff9b08367071c515f6627be833f1a
            type: 'GET',
        },
        "columnDefs": [{
