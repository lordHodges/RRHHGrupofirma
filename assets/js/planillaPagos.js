...
function cargarTablaPlanillaPagoMes (){
  ...
  $('.dataTables-planillaBanco').DataTable({
    ...
    // "dom": '<"top"f>rt<"bottom"flp><"clear">',
        ...
        "ajax": {
            url: 'http://10.10.10.1/grupofirma/index.php/getListadoPlanillaPagoMes?year='+anoActual+'&&mes='+mesActual+'&&diaTermino='+diaTermino+'&&empresa='+empresa,
            type: 'GET',
            data: {}
        },
        "columnDefs": [{
...
function cargarTablaPagosFinDeMes(){
  ...
  $('.dataTables-tabla_pagos5').DataTable({
    ...
    // "dom": '<"top"f>rt<"bottom"flp><"clear">',
        ...
        "ajax": {
            url: 'http://10.10.10.1/grupofirma/index.php/getListadoPagosFinDeMes?year='+anoActual+'&&mes='+mesActual+'&&diaTermino='+diaTermino+'&&empresa='+empresa,
            type: 'GET',
            data: {}
        },
        "columnDefs": [{
