...
function cargarTablaSucursales(permisoExportar) {
	...
	if (permisoExportar == "si") {
		$(".dataTables-sucursales").DataTable({
			...
			ajax: {
				url: "https://www.imlchile.cl/dev_test/grupofirma/index.php/getListadoSucursales",
				type: "GET",
			},
			columnDefs: [{}],
		...
		columnDefs: [
			{
				...
				data: null,
				defaultContent:
					'<button type="button" id="getDetallePrevision" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modalEditarPrevision"><i class="glyphicon glyphicon-pencil"></i></button>',
			},
		],
		dom: '<"html5buttons"B>lTfgitp',
		buttons: [
...
function cargarTablaNacionalidades(permisoEditar, permisoExportar) {
	...
	if (permisoEditar == "si") {
		btnAcciones =
			'<button type="button" id="getDetalleNacionalidad" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modalEditarNacionalidad"><i class="glyphicon glyphicon-pencil"></i></button>';
	}
	...
	if (permisoExportar == "si") {
		$(".dataTables-sucursales").DataTable({
			...
			ajax: {
				url: "https://www.imlchile.cl/dev_test/grupofirma/index.php/getListadoNacionalidades",
				type: "GET",
			},
			columnDefs: [
				{
...
function cargarTablaEstadosContrato(permisoEditar, permisoExportar) {
	...
	if (permisoEditar == "si") {
		btnAcciones =
			'<button type="button" id="getDetalleEstadosContrato" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modalEditarEstadosContrato"><i class="glyphicon glyphicon-pencil"></i></button>';
	}
	...
	if (permisoExportar == "si") {
		$(".dataTables-estadoContrato").DataTable({
			...
			ajax: {
				url: "https://www.imlchile.cl/dev_test/grupofirma/index.php/getEstadoContrato",
				type: "GET",
			},
			columnDefs: [
				{
...
function cargarTablaEstadosCiviles(permisoExportar) {
	...
	if (permisoExportar == "si") {
		$(".dataTables-estadoCivil").DataTable({
			...
			ajax: {
				url: "https://www.imlchile.cl/dev_test/grupofirma/index.php/getListadoEstadosCiviles",
				type: "GET",
			},
			columnDefs: [{}],
			dom: '<"html5buttons"B>lTfgitp',
...
function cargarTablaBancos(exportar) {
	...
	if (exportar == "si") {
		$(".dataTables-bancos").DataTable({
			...
			ajax: {
				url: "https://www.imlchile.cl/dev_test/grupofirma/index.php/getListadoBancos",
				type: "GET",
			},
			columnDefs: [{}],
			dom: '<"html5buttons"B>lTfgitp',
...
function cargarTablaCiudades(exportar) {
	...
	if (exportar == "si") {
		$(".dataTables-ciudades").DataTable({
			...
			ajax: {
				url: "https://www.imlchile.cl/dev_test/grupofirma/index.php/getListadoCiudades",
				type: "GET",
			},
			columnDefs: [{}],
			dom: '<"html5buttons"B>lTfgitp',
...
function cargarTablaEmpresa(permisoEditar, exportar) {
	...
	if (permisoEditar == "si") {
		btnAcciones =
			'<button type="button" id="getDetalleEmpresa" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modalEditarEmpresa"><i class="glyphicon glyphicon-pencil"></i></button>';
	}
	...
	if (exportar == "si") {
		$(".dataTables-prevision").DataTable({
			...
			ajax: {
				url: "https://www.imlchile.cl/dev_test/grupofirma/index.php/getListadoEmpresa",
				type: "GET",
			},
			columnDefs: [
				{
...
function cargarTablaAFP(permisoEditar, permisoExportar) {
	...
	if (permisoEditar == "si") {
		btnAcciones =
			'<button type="button" id="btnVerAFP" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modaleditarAFP"><i class="glyphicon glyphicon-pencil"></i></button>';
	}
...
function getSelectCiudad() {
	...
	$.getJSON(url, function (result) {
		$.each(result, function (i, o) {
			fila +=
				"<option value='" + o.cp_ciudad + "'>" + o.atr_nombre + "</option>";
		});
...
function getSelectBanco() {
	...
	$.getJSON(url, function (result) {
		$.each(result, function (i, o) {
			fila +=
				"<option value='" + o.cp_banco + "'>" + o.atr_nombre + "</option>";
		});
...
function getSelectCargos() {
	...
	$.getJSON(url, function (result) {
		$.each(result, function (i, o) {
			fila +=
				"<option value='" + o.cp_cargo + "'>" + o.atr_nombre + "</option>";
		});
...
function getSucursales() {
	...
	$.getJSON(url, function (result) {
		$.each(result, function (i, o) {
			fila +=
				"<option value='" + o.cp_sucursal + "'>" + o.atr_nombre + "</option>";
		});
...
function getEmpresas() {
	...
	$.getJSON(url, function (result) {
		$.each(result, function (i, o) {
			fila +=
				"<option value='" + o.cp_empresa + "'>" + o.atr_nombre + "</option>";
		});
...
function getPrevisiones() {
	...
	$.getJSON(url, function (result) {
		$.each(result, function (i, o) {
			fila +=
				"<option value='" + o.cp_prevision + "'>" + o.atr_nombre + "</option>";
		});
...
function getDetallePrevision(idPrevision) {
	...
	$.ajax({
		...
		$.each(msg.msg, function (i, o) {
			fila +=
				'<h5 class="modal-title mx-auto">PREVISIÓN</h5><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>';
			fila +=
				'<div class="col-md-12"><br><label for="nombre">NOMBRE:&nbsp; </label><label id="idPrevision" style="color:#2A3F54;">' +
				o.cp_prevision +
				'</label><input type="text" style="color:#848484" class="form-control custom-input-sm" id="nombreNuevo" value="' +
				o.atr_nombre +
				'"></div>';
...
function getEstadosContrato() {
	...
	$.getJSON(url, function (result) {
		$.each(result, function (i, o) {
			fila +=
				"<option value='" + o.cp_estado + "'>" + o.atr_nombre + "</option>";
		});
...
function getDetalleEstadosContrato(idEstadoContrato) {
	...
	$.ajax({
		...
		$.each(msg.msg, function (i, o) {
			fila +=
				'<h5 class="modal-title mx-auto">ESTADO CONTRATO</h5><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>';
			fila +=
				'<div class="col-md-12"><br><label for="nombre">NOMBRE:&nbsp; </label><label id="idEstadoContrato" style="color:#2A3F54;">' +
				o.cp_estado +
				'</label><input type="text" style="color:#848484" class="form-control custom-input-sm" id="nombreNuevo" value="' +
				o.atr_nombre +
				'"></div>';
...
function getDetalleNacionalidad(idNacionalidad) {
	...
	$.ajax({
		...
		$.each(msg.msg, function (i, o) {
			fila +=
				'<h5 class="modal-title mx-auto">NACIONALIDAD</h5><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>';
			fila +=
				'<div class="col-md-12"><br><label for="nombre">NOMBRE:&nbsp; </label><label id="idNacionalidad" style="color:#2A3F54;">' +
				o.cp_nacionalidad +
				'</label><input type="text" style="color:#848484" class="form-control custom-input-sm" id="nombreNuevo" value="' +
				o.atr_nombre +
				'"></div>';
...
function getDetalleAFP(id) {
	...
	$.ajax({
		...
		$.each(msg.msg, function (i, o) {
			...
			fila +=
				'<div class="col-md-12"><br><label for="nombre">NOMBRE: &nbsp;&nbsp;</label><label id="idAFP" style="color:#2a3f54">' +
				o.cp_afp +
				'</label> <input type="text" placeholder="Ingrese nuevo nombre" style="color:#848484" value="' +
				o.atr_nombre +
				'" class="form-control custom-input-sm" id="nombreNuevo"></div>';
...
function editarAFP(id) {
	...
	if (nombreNuevo == "") {
		...
		$.ajax({
			...
			type: "POST",
			dataType: "json",
			data: { nombreNuevo: nombreNuevo, idAFP: idAFP },
		}).then(function (msg) {
			if (msg.msg == "ok") {
...
function getDetalleEmpresa(idEmpresa) {
	...
	$.ajax({
		...
		$.each(msg.msg, function (i, o) {
			fila +=
				'<h5 class="modal-title mx-auto">EMPRESA</h5><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>';
			fila +=
				'<div class="col-md-12"><br><label for="nombre">NOMBRE:&nbsp; </label><label id="idEmpresa" style="color:#2A3F54;">' +
				o.cp_empresa +
				'</label><input type="text" class="form-control custom-input-sm" value="' +
				o.atr_nombre +
				'" style="color:#848484;" id="nombreNuevo" oninput="mayus(this);"></div>';
			fila +=
				'<div class="col-md-12"><br><label for="rut">ROL UNICO TRIBUTARIO:&nbsp;</label><input type="text" class="form-control custom-input-sm" id="rutNuevo" onkeyup="this.value=caracteresRUT(this.value)" value="' +
				o.atr_run +
				'" style="color:#848484;" oninput="checkRutOficial(this)"></div>';
			fila +=
				'<div class="col-md-12"><br><label for="ubicacion">UBICACIÓN:&nbsp;</label><input type="text" class="form-control custom-input-sm" id="ubicacionNuevo" value="' +
				o.atr_domicilio +
				'" style="color:#848484;" oninput="mayus(this);"></div>';
			fila +=
				'<div class="col-md-12"><br><label for="nombreRepre">NOMBRE DE REPRESENTANTE:&nbsp;</label><input type="text" class="form-control custom-input-sm" id="nombreRepreNuevo" oninput="mayus(this);" value="' +
				o.atr_representante +
				'" style="color:#848484;" onkeyup="this.value=soloLetras(this.value)" ></div>';
			fila +=
				'<div class="col-md-12"><br><label for="cedulaRepre">CÉLUDA DE REPRESENTANTE:&nbsp;</label><input type="text" class="form-control custom-input-sm" value="' +
				o.atr_cedula_representante +
				'" style="color:#848484;" id="cedulaRepreNuevo" onkeyup="this.value=caracteresRUT(this.value)" oninput="checkRutOficial(this)"></div>';

			fila +=
				'<div class="col-md-12"><br> <label for="getSelectCiudad">CIUDAD:&nbsp;</label><label id="ciudadActual">' +
				o.nombreCiudad +
				'</label><br> <select class="custom-select" id="getSelectCiudad2"> ';
