...
function cargarTablaSucursales(permisoExportar) {
	...
	if (permisoExportar == "si") {
		$(".dataTables-sucursales").DataTable({
			...
			ajax: {
				url: "http://www.imlchilel.cl/grupofirma/index.php/getListadoSucursales",
				type: "GET",
			},
			columnDefs: [{}],
...
function cargarTablaNacionalidades(permisoEditar, permisoExportar) {
	...
	if (permisoExportar == "si") {
		$(".dataTables-sucursales").DataTable({
			...
			ajax: {
				url: "http://www.imlchilel.cl/grupofirma/index.php/getListadoNacionalidades",
				type: "GET",
			},
			columnDefs: [
				{
...
function cargarTablaEstadosContrato(permisoEditar, permisoExportar) {
	...
	if (permisoExportar == "si") {
		$(".dataTables-estadoContrato").DataTable({
			...
			ajax: {
				url: "http://www.imlchilel.cl/grupofirma/index.php/getEstadoContrato",
				type: "GET",
			},
			columnDefs: [
				{
...
function cargarTablaEstadosCiviles(permisoExportar) {
	...
	if (permisoExportar == "si") {
		$(".dataTables-estadoCivil").DataTable({
			...
			ajax: {
				url: "http://www.imlchilel.cl/grupofirma/index.php/getListadoEstadosCiviles",
				type: "GET",
			},
			columnDefs: [{}],
			dom: '<"html5buttons"B>lTfgitp',
...
function cargarTablaBancos(exportar) {
	...
	if (exportar == "si") {
		$(".dataTables-bancos").DataTable({
			...
			ajax: {
				url: "http://www.imlchilel.cl/grupofirma/index.php/getListadoBancos",
				type: "GET",
			},
			columnDefs: [{}],
			dom: '<"html5buttons"B>lTfgitp',
...
function cargarTablaCiudades(exportar) {
	...
	if (exportar == "si") {
		$(".dataTables-ciudades").DataTable({
			...
			ajax: {
				url: "http://www.imlchilel.cl/grupofirma/index.php/getListadoCiudades",
				type: "GET",
			},
			columnDefs: [{}],
			dom: '<"html5buttons"B>lTfgitp',
...
function cargarTablaEmpresa(permisoEditar, exportar) {
	...
	if (exportar == "si") {
		$(".dataTables-prevision").DataTable({
			...
			ajax: {
				url: "http://www.imlchilel.cl/grupofirma/index.php/getListadoEmpresa",
				type: "GET",
			},
			columnDefs: [
				{
