	...
	$.ajax({
		...
		$.each(msg.msg, function (i, o) {
			if (o.atr_tipo == "Contrato") {
				urlDescarga =
					"http://www.imlchilel.cl/grupofirma/index.php/ContratosController/descargarContrato/" + o.cf_contrato;
				...
				urlDescarga =
					"http://www.imlchilel.cl/grupofirma/index.php/ContratosController/descargarAnexo/" + o.cf_anexo;
			} else {
				urlDescarga =
					"http://www.imlchilel.cl/grupofirma/index.php/TransferenciasController/descargarComprobante/" +
					o.cf_transferencia;
...
function cargarDetalleContratos(idTrabajador) {
	$.ajax({
		...
		$.each(msg.msg, function (i, o) {
			urlDescarga =
				"http://www.imlchilel.cl/grupofirma/index.php/ContratosController/descargarContrato/" + o.cp_contrato;
...
function cargarDetalleAnexos(idTrabajador) {
	$.ajax({
		...
		$.each(msg.msg, function (i, o) {
			urlDescarga =
				"http://www.imlchilel.cl/grupofirma/index.php/ContratosController/descargarAnexo/" + o.cp_anexo;
...
function cargarDetallePrestamosPorFecha(mes, ano, idTrabajador) {
	$.ajax({
		...
		$.each(msg.msg, function (i, o) {
			...
			if (fecha[0] == ano && fecha[1] == mes) {
				urlDescarga =
					"http://www.imlchilel.cl/grupofirma/index.php/PrestamosController/descargarComprobante/" +
					o.cp_prestamo;
