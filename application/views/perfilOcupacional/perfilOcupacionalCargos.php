...
<?php
$view_verPerfilOcupacional = 0;
$view_generarPDF = 0;
foreach ($permisos as $key => $value) {
  if ($value->cf_existencia_permiso == "64") {
    $view_verPerfilOcupacional = "1";
  } else
  if ($value->cf_existencia_permiso == "65") {
    $view_generarPDF = "1";
  }
}
  ...
  <script>
    $(document).ready(function() {
      ...
      $('.dataTables-cargos').DataTable({
        ...
        "ajax": {
          url: "https://www.imlchile.cl/dev_test/grupofirma/index.php/getlistadecargos",
          type: 'GET'
        },
        "columnDefs": [{
          "targets": 5,
    ...
    $("body").on("click", "#btnVerDocumentoPerfilOcupacional", function(e) {
      ...
      var url = 'https://www.imlchile.cl/dev_test/grupofirma/index.php/docPerfilesOcupacionales?cargo=' + idCargo;
