  ...
  <script>
    $(document).ready(function() {
      ...
      $('.dataTables-cargos').DataTable({
        ...
        "ajax": {
          url: "http://www.imlchilel.cl/grupofirma/index.php/getlistadecargos",
          type: 'GET'
        },
        "columnDefs": [{
          "targets": 5,
    ...
    $("body").on("click", "#btnVerDocumentoPerfilOcupacional", function(e) {
      ...
      var url = 'http://www.imlchilel.cl/grupofirma/index.php/docPerfilesOcupacionales?cargo=' + idCargo;
