...
<?php
$view_verCompetencia = 0;
$view_crearCompetencia = 0;
$view_eliminarCompetencia = 0;
foreach ($permisos as $key => $value) {
  if ($value->cf_existencia_permiso == "45") {
    $view_verCompetencia = "1";
  } else
  if ($value->cf_existencia_permiso == "46") {
    $view_crearCompetencia = "1";
  } else
  if ($value->cf_existencia_permiso == "47") {
    $view_eliminarCompetencia = "1";
  }
}
        ...
        <div class="row">
          <div class="col-md-12" id="ocultarTabla">
            ...
            <?php if ($view_verCompetencia == "1") {  ?>
              <table id="tabla_competencias" class="table table-striped table-bordered table-hover dataTables-competencias" style="margin-top:20px; width:100%">
                <thead>
                  <tr style="width:100%;">
