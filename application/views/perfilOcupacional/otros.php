...
$view_crearOtro = 0;
$view_eliminarOtro = 0;
$view_crearOtroTitulo = 0;
foreach ($permisos as $key => $value) {
  if ($value->cf_existencia_permiso == "51") {
    $view_verOtro = "1";
  } else
  if ($value->cf_existencia_permiso == "52") {
    $view_crearOtro = "1";
  } else
  if ($value->cf_existencia_permiso == "54") {
    $view_crearOtroTitulo = "1";
  } else
  if ($value->cf_existencia_permiso == "53") {
    $view_eliminarOtro = "1";
  }
}
        ...
        <div class="row">
          <div class="col-md-12" id="ocultarTabla">
            ...
            <?php if ($view_verOtro == "1") {  ?>
              <table id="tabla_otrosAntecedentes" class="table table-striped table-bordered table-hover dataTables-otrosAntecedentes" style="margin-top:20px; width:100%">
                <thead>
                  <tr style="width:100%;">
