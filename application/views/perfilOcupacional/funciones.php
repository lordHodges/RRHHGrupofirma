...
$view_verFuncion = 0;
$view_crearFuncion = 0;
$view_eliminarFuncion = 0;
foreach ($permisos as $key => $value) {
  if ($value->cf_existencia_permiso == "42") {
    $view_verFuncion = "1";
  } else
  if ($value->cf_existencia_permiso == "43") {
    $view_crearFuncion = "1";
  } else
  if ($value->cf_existencia_permiso == "44") {
    $view_eliminarFuncion = "1";
  }
}
        ...
        <div class="row">
          <div class="col-md-12" id="ocultarTabla">
            ...
            <?php if ($view_verFuncion == "1") {  ?>
              <table id="tabla_funciones" class="table table-striped table-bordered table-hover dataTables-funciones" style="margin-top:20px; width:100%">
                <thead>
                  <tr style="width:100%;">
