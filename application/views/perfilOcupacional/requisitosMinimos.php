...
foreach ($permisos as $key => $value) {
  if ($value->cf_existencia_permiso == "39") {
    $view_verRM = "1";
  } else
  if ($value->cf_existencia_permiso == "40") {
    $view_crearRM = "1";
  } else
  if ($value->cf_existencia_permiso == "41") {
    $view_eliminarRM = "1";
  }
}
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12" id="ocultarTabla">
            ...
            <?php if ($view_verRM == "1") {  ?>
              <table id="tabla_requerimientosMinimos" class="table table-striped table-bordered table-hover dataTables-requerimientosMinimos" style="margin-top:20px; width:100%">
                <thead>
                  <tr style="width:100%;">
