...
<?php
$view_verAdelantos = 0;
$view_editarAdelanto = 0;
$view_exportarAdelanto = 0;
foreach ($permisos as $key => $value) {
  if ($value->cf_existencia_permiso == "102") {
    $view_verAdelantos = "1";
  } else
  if ($value->cf_existencia_permiso == "103") {
    $view_editarAdelanto = "1";
  } else
  if ($value->cf_existencia_permiso == "104") {
    $view_exportarAdelanto = "1";
  }
}
