...
<?php
$view_anexoModificacionClausula = 0;
foreach ($permisos as $key => $value) {
  if ($value->cf_existencia_permiso == "66") {
    $view_anexoModificacionClausula = "1";
  }
}

if ($usuario[0]->atr_activo == "1" &&  $view_anexoModificacionClausula == "1") { ?>
  ...
  <body>
    ...
    <h4 style="display:inline">
      <h4 style="text-decoration: underline;display:inline">Cláusula adicional:</h4>
    </h4>
