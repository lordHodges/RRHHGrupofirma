...
if ($usuario[0]->atr_activo == "1" && $view_contratoEstadar == "1") { ?>
  ...
  <body>
    ...
    <br>
    <h4 style="display:inline">II.&nbsp;&nbsp; <h4 style="text-decoration: underline;display:inline">Naturaleza de los servicios</h4>
    </h4>
    ...
    <br>
    <h4 style="display:inline">III.&nbsp;&nbsp; <h4 style="text-decoration: underline;display:inline">Lugar de la prestación de servicios</h4>
    </h4>
    ...
    <h4 style="display:inline">IV.&nbsp;&nbsp; <h4 style="text-decoration: underline;display:inline">Jornada de trabajo</h4>
    </h4>
    ...
    <h4 style="display:inline">V.&nbsp;&nbsp; <h4 style="text-decoration: underline;display:inline">Remuneraciones</h4>
    </h4>
    ...
    <h4 style="display:inline">VI.&nbsp;&nbsp; <h4 style="text-decoration: underline;display:inline">Duración de la relación jurídica laboral</h4>
    </h4>
    ...
    <h4 style="display:inline">VII.&nbsp;&nbsp; <h4 style="text-decoration: underline;display:inline">Cláusula de la vigencia</h4>
    </h4>
    ...
    <h4 style="display:inline">VIII.&nbsp;&nbsp; <h4 style="text-decoration: underline;display:inline">A tener en cuenta</h4>
    </h4>
