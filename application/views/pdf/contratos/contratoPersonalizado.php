...
foreach ($permisos as $key => $value) {
  if ($value->cf_existencia_permiso == "69") {
    $view_contratoPersonalizado = "1";
  }
}
...
if ($usuario[0]->atr_activo == "1" && $view_contratoPersonalizado == "1") { ?>
      ...
      <?php switch ($itemsContrato[$i]) {
        ...
        case "Partes": ?>
          <?php foreach ($arrayTrabajador as $key => $t) { ?>
            <br>
            <h4 style="display:inline"><?php echo ($numeroRomano[$i]) ?>.&nbsp;&nbsp; <h4 style="text-decoration: underline;display:inline">Partes</h4>
            </h4>
        ...
        case "Naturaleza de los servicios": ?>
          ...
          <br>
          <h4 style="display:inline"><?php echo ($numeroRomano[$i])  ?>.&nbsp;&nbsp; <h4 style="text-decoration: underline;display:inline">Naturaleza de los servicios</h4>
          </h4>
        ...
        case "Lugar de prestación de servicios": ?>
          <br>
          <h4 style="display:inline"><?php echo ($numeroRomano[$i])  ?>.&nbsp;&nbsp; <h4 style="text-decoration: underline;display:inline">Lugar de la prestación de servicios</h4>
          </h4>
        ...
        case "Jornada de trabajo": ?>
          <br>
          <h4 style="display:inline"><?php echo ($numeroRomano[$i])  ?>.&nbsp;&nbsp; <h4 style="text-decoration: underline;display:inline">Jornada de trabajo</h4>
          </h4>
        ...
        case "Remuneraciones": ?>
          <br>
          <h4 style="display:inline"><?php echo ($numeroRomano[$i])  ?>.&nbsp;&nbsp; <h4 style="text-decoration: underline;display:inline">Remuneraciones</h4>
          </h4>
        ...
        case "Duración de la relación jurídica laboral": ?>
          <br>
          <h4 style="display:inline"><?php echo ($numeroRomano[$i])  ?>.&nbsp;&nbsp; <h4 style="text-decoration: underline;display:inline">Duración de la relación jurídica laboral</h4>
          </h4>
        ...
        case "Cláusula de vigencia": ?>
          <br>
          <h4 style="display:inline"><?php echo ($numeroRomano[$i])  ?>.&nbsp;&nbsp; <h4 style="text-decoration: underline;display:inline">Cláusula de la vigencia</h4>
          </h4>
        ...
        case "A tener en cuenta": ?>
          <br>
          <h4 style="display:inline"><?php echo ($numeroRomano[$i])  ?>.&nbsp;&nbsp; <h4 style="text-decoration: underline;display:inline">A tener en cuenta</h4>
          </h4>
        ...
        case "Cláusula de confidencialidad": ?>
          <br>
          <h4 style="display:inline"><?php echo ($numeroRomano[$i])  ?>.&nbsp;&nbsp; <h4 style="text-decoration: underline;display:inline">Claúsula de confidencialidad</h4>
          </h4>
        ...
        case "Propiedad intelectual": ?>
          <br>
          <h4 style="display:inline"><?php echo ($numeroRomano[$i])  ?>.&nbsp;&nbsp; <h4 style="text-decoration: underline;display:inline">Propiedad intelectual</h4>
          </h4>
          <p style="text-align:justify; line-height:25px;">
  ...
  <?php } else {
  header("Location: http://www.rrhh.cl/");
} ?>
