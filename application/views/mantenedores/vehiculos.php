...
<?php
$view_verVehiculos = 0; $view_crearVehiculo = 0; $view_exportarVehiculos = 0; $view_editarVehiculo = 0;
foreach ($permisos as $key => $value) {
  if ($value->cf_existencia_permiso == "9") { $view_verVehiculos = "1"; } else
  if ($value->cf_existencia_permiso == "10") { $view_crearVehiculo = "1"; } else
  if ($value->cf_existencia_permiso == "11") { $view_editarVehiculo = "1"; } else
  if ($value->cf_existencia_permiso == "12") { $view_exportarVehiculos = "1"; }
}
...
<div class="right_col" role="main">
    ...
    <div class="row">
        <div class="x_panel">
            <div class="x_content">
              <h3 class="text-center">VEHÍCULOS</h3><br>
              <?php if ( $view_crearVehiculo == 1 ) {  ?>
                <button type="button" id="btnAbrirModalCrear" class="btn modidev-btn btn-sm" data-toggle="modal" data-target=".bd-example-modal-lg" style="margin-bottom:20px;">INGRESAR VEHÍCULO</button>
              <?php } ?>

                <?php if ($view_verVehiculos == "1") {  ?>
    ...
    <div id="myModal" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="crearTrabajador"  aria-hidden="true" >
        <div class="modal-dialog modal-lg">
            <div class="modal-content" style="padding:20px; background: #2a3f54" >
                <div class="">
                    <h5 class="modal-title mx-auto">INGRESAR VEHÍCULO</h5>
    ...
    <script>
      $(document).ready(function() {
        ...
        <?php if( $view_editarVehiculo == 1 ){  ?>
          permisoEditar = "si";
          $("#permisoEditar").text("si");
        <?php } ?>
        <?php if( $view_exportarVehiculos == 1 ){  ?>
            permisoExportar = "si";
