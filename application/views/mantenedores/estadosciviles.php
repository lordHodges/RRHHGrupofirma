...
<?php
$view_verEstadoCivil = 0;
$view_crearEstadoCIvil = 0;
$view_exportarEstadoCivil = 0;
foreach ($permisos as $key => $value) {
  if ($value->cf_existencia_permiso == "13") {
    $view_verEstadoCivil = "1";
  } else
  if ($value->cf_existencia_permiso == "14") {
    $view_crearEstadoCIvil = "1";
  } else
  if ($value->cf_existencia_permiso == "15") {
    $view_exportarEstadoCivil = "1";
  }
}
