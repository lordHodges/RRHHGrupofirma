...
$view_verModelos = 0;
$view_crearModelo = 0;
$view_exportarModelos = 0;
$view_editarModelo = 0;
foreach ($permisos as $key => $value) {
    if ($value->cf_existencia_permiso == "98") {
        $view_verModelos = "1";
    } else
  if ($value->cf_existencia_permiso == "100") {
        $view_crearModelo = "1";
    } else
  if ($value->cf_existencia_permiso == "101") {
        $view_exportarModelos = "1";
    } else
  if ($value->cf_existencia_permiso == "99") {
        $view_editarModelo = "1";
    }
}
