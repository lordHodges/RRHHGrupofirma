...
$view_verMarcas = 0;
$view_crearMarca = 0;
$view_exportarMarcas = 0;
$view_editarMarca = 0;
foreach ($permisos as $key => $value) {
    if ($value->cf_existencia_permiso == "94") {
        $view_verMarcas = "1";
    } else
  if ($value->cf_existencia_permiso == "97") {
        $view_crearMarca = "1";
    } else
  if ($value->cf_existencia_permiso == "96") {
        $view_exportarMarcas = "1";
    } else
  if ($value->cf_existencia_permiso == "95") {
        $view_editarMarca = "1";
    }
}
