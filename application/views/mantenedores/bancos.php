...
<?php
$view_verBanco = 0; $view_crearBanco = 0; $view_exportarBanco = 0;
foreach ($permisos as $key => $value) {
  if ($value->cf_existencia_permiso == "119") { $view_verBanco = "1"; } else
  if ($value->cf_existencia_permiso == "120") { $view_crearBanco = "1"; } else
  if ($value->cf_existencia_permiso == "121") { $view_exportarBanco = "1"; }
}
