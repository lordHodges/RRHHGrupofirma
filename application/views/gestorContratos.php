    ...
    <script>
      ...
      $("body").on("click", "#btnGenerarContrato", function(e) {
          ...
          if(fechaInicio == "" || fechaInicio == null || fechaTermino == "" || fechaTermino == null){
            ...
            var url = 'http://10.10.11.240/RRHH-FIRMA/index.php/docContratoEstandar?trabajador='+idTrabajador+'&&fechaInicio='+fechaInicio+'&&fechaTermino='+fechaTermino+'&&ciudadFirma='+ciudadFirma;
      ...
      $("body").on("click", "#btnGenerarContrato2", function(e) {
          ...
          if(fechaInicio == "" || fechaInicio == null || fechaTermino == "" || fechaTermino == null){
            ...
            var url = 'http://10.10.11.240/RRHH-FIRMA/index.php/docContratoPersonalizado?trabajador='+idTrabajador+'&&fechaInicio='+fechaInicio+'&&fechaTermino='+fechaTermino+'&&ciudadFirma='+ciudadFirma+'&&arrayItems='+arrayItems;
            window.open(url, '_blank');
        }
