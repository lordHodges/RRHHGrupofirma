    ...
    <script>
      ...
      $("body").on("click", "#btnGenerarContrato", function(e) {
        ...
        if (fechaInicio == "" || fechaInicio == null || fechaTermino == "" || fechaTermino == null) {
          ...
          var url = 'http://www.imlchile.cl/dev_test/grupofirmaindex.php/docContratoEstandar?trabajador=' + idTrabajador + '&&fechaInicio=' + fechaInicio + '&&fechaTermino=' + fechaTermino + '&&ciudadFirma=' + ciudadFirma;
      ...
      $("body").on("click", "#btnGenerarContrato2", function(e) {
        ...
        if (fechaInicio == "" || fechaInicio == null || fechaTermino == "" || fechaTermino == null) {
          ...
          var url = 'http://www.imlchile.cl/dev_test/grupofirmaindex.php/docContratoPersonalizado?trabajador=' + idTrabajador + '&&fechaInicio=' + fechaInicio + '&&fechaTermino=' + fechaTermino + '&&ciudadFirma=' + ciudadFirma + '&&arrayItems=' + arrayItems;
          window.open(url, '_blank');
        }
