    ...
    <script>
      ...
      $("body").on("click", "#btnGenerarContrato", function(e) {
        ...
        if (fechaInicio == "" || fechaInicio == null || fechaTermino == "" || fechaTermino == null) {
          ...
          var url = 'http://localhost/RRHHGrupofirma/index.php/docContratoEstandar?trabajador=' + idTrabajador + '&&fechaInicio=' + fechaInicio + '&&fechaTermino=' + fechaTermino + '&&ciudadFirma=' + ciudadFirma;
      ...
      $("body").on("click", "#btnGenerarContrato2", function(e) {
        ...
        if (fechaInicio == "" || fechaInicio == null || fechaTermino == "" || fechaTermino == null) {
          ...
          var url = 'http://localhost/RRHHGrupofirma/index.php/docContratoPersonalizado?trabajador=' + idTrabajador + '&&fechaInicio=' + fechaInicio + '&&fechaTermino=' + fechaTermino + '&&ciudadFirma=' + ciudadFirma + '&&arrayItems=' + arrayItems;
          window.open(url, '_blank');
        }
