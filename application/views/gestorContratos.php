...
<?php
$view_estandar = 0;
$view_personalizado = 0;
foreach ($permisos as $key => $value) {
  if ($value->cf_existencia_permiso == "69") {
    $view_estandar = "1";
  } else
  if ($value->cf_existencia_permiso == "70") {
    $view_personalizado = "1";
  }
}
        ...
        <div class="tab-content" id="myTabContent">
          ...
          <div class="tab-pane fade show active" id="estandarContent" role="tabpanel" aria-labelledby="estandar">
            ...
            <div id="remuneración" style="display:none">
              <div class="col-md-12">
                <br>
                <h4 style="color:#2a3f54"><b>III ) REMUNERACIÓN</b></h4>
              </div>
            ...
            <div id="vigencia" style="display:none">
              <div class="col-md-12">
                <br>
                <h4 style="color:#2a3f54"><b>IV ) VIGENCIA</b></h4>
              </div>
              <div class="col-md-6">
                <br>
            ...
            <div id="itemsContrato" style="display:none">
              <div class="col-md-12">
                <br>
                <h4 style="color:#2a3f54"><b>V ) ITEMS DEL CONTRATO</b></h4>
              </div>
              <ul style="list-style:none">
                ...
                <li>
                  <h6 style="color:#49505c;">VI. Duración de la relación jurídica laboral</h6>
                </li>
                <li>
    ...
    <script>
      ...
      $("body").on("click", "#btnGenerarContrato", function(e) {
        ...
        if (fechaInicio == "" || fechaInicio == null || fechaTermino == "" || fechaTermino == null) {
          ...
          var url = 'https://www.imlchile.cl/dev_test/grupofirma/index.php/docContratoEstandar?trabajador=' + idTrabajador + '&&fechaInicio=' + fechaInicio + '&&fechaTermino=' + fechaTermino + '&&ciudadFirma=' + ciudadFirma;
      ...
      $("body").on("click", "#btnGenerarContrato2", function(e) {
        ...
        if (fechaInicio == "" || fechaInicio == null || fechaTermino == "" || fechaTermino == null) {
          ...
          var url = 'https://www.imlchile.cl/dev_test/grupofirma/index.php/docContratoPersonalizado?trabajador=' + idTrabajador + '&&fechaInicio=' + fechaInicio + '&&fechaTermino=' + fechaTermino + '&&ciudadFirma=' + ciudadFirma + '&&arrayItems=' + arrayItems;
          window.open(url, '_blank');
        }
