...
<?php
$view_verLiquidaciones = 0;
$view_subirLiquidacion = 0;
$view_descargarLiquidacion = 0;
foreach ($permisos as $key => $value) {
  if ($value->cf_existencia_permiso == "84") {
    $view_verLiquidaciones = "1";
  } else
  if ($value->cf_existencia_permiso == "85") {
    $view_subirLiquidacion  = "1";
  } else
  if ($value->cf_existencia_permiso == "86") {
    $view_descargarLiquidacion  = "1";
  }
}
