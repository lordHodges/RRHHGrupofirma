...
<?php
$view_verPrestamos = 0;
$view_crearPrestamo = 0;
$view_editarPrestamo = 0;
$view_exportarPrestamo = 0;
foreach ($permisos as $key => $value) {
  if ($value->cf_existencia_permiso == "106") {
    $view_verPrestamos = "1";
  } else
  if ($value->cf_existencia_permiso == "107") {
    $view_crearPrestamo = "1";
  } else
  if ($value->cf_existencia_permiso == "109") {
    $view_editarPrestamo = "1";
  } else
  if ($value->cf_existencia_permiso == "108") {
    $view_exportarPrestamo = "1";
  }
}
...
if ($usuario[0]->atr_activo == "1") { ?>
  ...
  <script>
    ...
    $("body").on("click", "#btnGenerarComprobantePrestamo", function(e) {
      ...
      var url = 'http://www.rrhh.cl/index.php/docPrestamo?id=' + idPrestamo;
